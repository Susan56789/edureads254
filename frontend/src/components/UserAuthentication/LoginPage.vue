    ...
    <div class="min-h-screen flex flex-col items-center justify-center bg-gray-300">
        <div class="flex flex-col bg-white shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-md w-full max-w-md">
            ...
            <button class="relative mt-6 border rounded-md py-2 text-sm text-gray-800 bg-gray-100 hover:bg-gray-200">
                <span class="absolute left-0 top-0 flex items-center justify-center h-full w-10 text-orange-500"><i
                    ...
                    <div class="flex flex-col mb-6">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email"
                                class="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-orange-400"
                    ...
                    <div class="flex items-center mb-6 -mt-4">
                        <div class="flex ml-auto">
                            <a href="/reset-password"
                                class="inline-flex text-xs sm:text-sm text-orange-500 hover:text-orange-700">Forgot
                                Your Password?</a>
                        </div>
                    </div>
            ...
            <div class="flex justify-center items-center mt-6">
                <a href="#" target="_blank"
                    ...
                    <a href="/sign-up" target="_blank" class="ml-2">You don't have an account?</a>
                </a>
            </div>
        </div>
    </div>
